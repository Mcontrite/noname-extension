    ...
    return {
        ...
        content: function (config, pack) {
            ...
            if (config.guanfangs) {
                ...
                lib.characterPack.mode_guozhan.gz_zhouyu = ['male', 'wu', 3, ['reyingzi', 'refanjian', 'gz_fanjian'],
                    ['gzskin']
                ]
                ...
                lib.characterPack.mode_guozhan.gz_re_nanhualaoxian = ['male', 'qun', 4, ['gzgongxiu', 'gzjinghe'],
                    ['gzskin']
                ]
            ...
            if (config.junzhengs) {
                ...
                lib.characterPack.mode_guozhan.gz_chenlin = ['male', 'wei', 3, ['bifa', 'songci'],
                    ['gzskin']
                ]
                ...
                lib.characterPack.mode_guozhan.gz_fengfangnv = ['female', 'qun', 3, ['tiqi', 'gz_jiangong']]
                ...
                lib.characterPack.mode_guozhan.gz_liangxing = ['male', 'qun', 4, ['lulve']]
            ...
            if (config.diys) {
                ...
                lib.characterPack.mode_guozhan.gz_ns_caimao = ['male', 'han', 4, ['nsdingzhou'],
                    ['doublegroup:han:wei']
                ]
                ...
                lib.characterPack.mode_guozhan.gz_guoyouzhi = ['male', 'shu', 3, ['gz_shuaiyan', 'moshou'],
                    ['gzskin']
                ]
                ...
                // 汉
                lib.characterPack.mode_guozhan.gz_zm_wuanguo = ["male", "han", 4, ["zmnuchui"],
            ...
            lib.characterSort.mode_guozhan.diy1 = [
                ...
                'gz_diy_liufu', 'gz_diy_hanlong',
                // 蜀
                'gz_diy_xizhenxihong', 'gz_zm_ehuan', 'gz_zm_liuxian', 'gz_guoyouzhi',
                'gz_jl_xianglang',
                // 吴
            ...
            lib.perfectPair.gongsunyuan = ['gongsunkang']
            ...
            lib.perfectPair.chenlin = ['sp_wangcan', 'raunyu']
        ...
        package: {
            ...
            skill: {
                ...
                skill: {
                    ...
                    gz_cuijin: {
                        ...
                        content: function () {
                            ...
                            event.target = target;
                            player.chooseToDiscard('he', get.prompt('gz_cuijin', target), '弃置一张牌并令' + get.translation(trigger.player) + '使用的【杀】伤害+1，但若其未造成伤害，则你对其造成1点伤害。', 2).set('ai', function (card) {
                    ...
                    zmnuchui: {
                        ...
                        forced: true,
                        content: function () {
                            if (!player.storage.zmnuchui.contains(trigger.player)) {
                                trigger.num++;
                                player.storage.zmnuchui.push(trigger.player);
                                player.syncStorage('zmnuchui');
                            } else if (player.storage.zmnuchui.contains(trigger.player)) {
                ...
                translate: {
                    ...
                    gz_rezhennan: '镇南',
                    gz_rezhennan_info: '当你成为其他角色使用的牌的目标后，若此牌的目标数大于该角色的体力值，则你可以弃置2张牌并对其造成1点伤害。',
                    gz_nuzhan: '怒斩',
